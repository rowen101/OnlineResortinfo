$(document).ready(function () {
    ...
    /* adding by ronel gonzales 4/22/2013 */
    $('#filetable_mydoc').dataTable({
        "bStateSave": true,
        "sPaginationType": "full_numbers",
        "oLanguage": {
            "sUrl": "includes/language/DataTables/datatables." + langLanguage + ".txt"
    ...
    if ($adminUser.length > 0) {
        $adminUser.change(function () {
            if ($(this).attr("checked")) {
                ...
                $('#userReviewDepartmentRow2').fadeOut(200);
                $('#userReviewDepartmentRow3').fadeOut(200);
                $('#userReviewDepartmentRow4').fadeOut(200);
                return;
            } else {
                $('#userReviewDepartmentRow').fadeIn(200);
                $('#userReviewDepartmentRow2').fadeIn(200);
                $('#userReviewDepartmentRow3').fadeIn(200);
                $('#userReviewDepartmentRow4').fadeIn(200);
